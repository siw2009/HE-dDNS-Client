...
namespace dDNS_Client
{
    public partial class HostSettings : Form
    {
        ...
        {
            this.UpdateArgs();
            this.HostForm.Text = this.args[3];
        }


        private void OKButton_Click(object sender, EventArgs e)
        {
            string newHost = this.HostForm.Text + "\0";
            ...
            for (int i = 0; i < newHost.Length && i < Global.CONFIG_ARGUMENTS_LENGTH; i++) { newConf[i + Global.CONFIG_ARGUMENTS_LENGTH * 3] = (byte)newHost[i]; }
